...
public class AutoH {
    ...
    public static boolean isAnvilBlock(BlockPos pos) {
        return BlockH.getBlock(pos) == Blocks.ANVIL || BlockH.getBlock(pos) == Blocks.CHIPPED_ANVIL || BlockH.getBlock(pos) == Blocks.DAMAGED_ANVIL;
    }

    public static boolean isWeb(BlockPos pos) {
        return BlockH.getBlock(pos) == Blocks.COBWEB || BlockH.getBlock(pos) == Block.getBlockFromItem(Items.STRING);
    }

    public static boolean isBurrowed(PlayerEntity p, boolean holeCheck) {
        BlockPos pos = p.getBlockPos();
        if (holeCheck && !Wrap.isInHole(p)) return false;
        return BlockH.getBlock(pos) == Blocks.ENDER_CHEST || BlockH.getBlock(pos) == Blocks.OBSIDIAN || isAnvilBlock(pos);
    }
    ...
    public static boolean isTrapBlock(BlockPos pos) {
        return BlockH.getBlock(pos) == Blocks.OBSIDIAN || BlockH.getBlock(pos) == Blocks.ENDER_CHEST;
    }
    ...
    public static boolean isSurroundBlock(BlockPos pos) {
        ...
        return BlockH.getBlock(pos) == Blocks.OBSIDIAN || BlockH.getBlock(pos) == Blocks.ENDER_CHEST || BlockH.getBlock(pos) == Blocks.RESPAWN_ANCHOR;
    }
    ...
    public static boolean canCrystal(PlayerEntity p) {
        ...
        for (Vec3d sp : surroundPositions) {
            ...
            if (BlockH.getBlock(sb) == Blocks.AIR) return true;
        }
        return false;
    }
    ...
    public static void doRegularMine(BlockPos targetPos) {
        ...
        Rotations.rotate(Rotations.getYaw(hitPos), Rotations.getPitch(hitPos), 50, () -> Wrap.swingHand(false));
    }
}
