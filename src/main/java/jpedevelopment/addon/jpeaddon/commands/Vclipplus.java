package jpedevelopment.addon.jpeaddon.commands;
...
public class Vclipplus extends Command {
    private MinecraftClient mc = MinecraftClient.getInstance();
    public Vclipplus() {super("Clip+", "Automatically clip vertically, up or down.", "avc");
    }
