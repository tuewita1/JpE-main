...
import jpedevelopment.addon.jpeaddon.utils.world.Task;
import jpedevelopment.addon.jpeaddon.utils.world.PacketUtils;
...
public class PacketMine extends JPEModule {
    ...
    public PacketMine() {
        super(JPEAddon.combat, "Mining+", "Romper Bloques Automaticamente");
    }
