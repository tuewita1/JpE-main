...
import jpedevelopment.addon.jpeaddon.utils.ModuleH.EmoH;
...
public class HelpChat extends JPEModule {
    ...
    public HelpChat() {
        super(JPEAddon.chat, "help-chat", "Various chat improvements.");
    }
    ...
    private void onMessageSend(SendMessageEvent event) {
        ...
        if (emotes.get()) message = EmoH.apply(message);
        event.message = message;
    }

    @Override
    public void onActivate() {
        ChatUtils.registerCustomPrefix("jpedevelopment.addon.jpeaddon.JPEAddon", this::getPrefix);
    }
