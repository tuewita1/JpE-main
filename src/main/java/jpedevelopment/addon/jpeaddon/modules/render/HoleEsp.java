...
import jpedevelopment.addon.jpeaddon.utils.entity.Utils;
...
public class HoleEsp extends JPEModule {
    ...
    public HoleEsp() {
        super(JPEAddon.renderer, "hole-esp", "Renders close safe-holes.");
    }
